...
namespace SharePoint.Client.Test
{
    ...
    public class TestRecurrence
    {
        ...
        {
            RecurrenceRule rule = SPRecurrenceHelper.ParseRule(DateTime.Now, DateTime.Now.AddYears(10), "<recurrence><rule><firstDayOfWeek>su</firstDayOfWeek><repeat><daily dayFrequency='1' weekday='FALSE'/></repeat><windowEnd>2016-01-02T23:00:00Z</windowEnd></rule></recurrence>");
            ...
            RecurrenceRule rule3 = SPRecurrenceHelper.ParseRule(DateTime.Now, DateTime.Now.AddYears(1), "<recurrence><rule><firstDayOfWeek>su</firstDayOfWeek><repeat><weekly tu='TRUE' weekFrequency='1' /></repeat><repeatForever>FALSE</repeatForever></rule></recurrence>");
            ...
            RecurrenceRule rule5 = SPRecurrenceHelper.ParseRule(DateTime.Now, DateTime.Now.AddYears(1), "<recurrence><rule><firstDayOfWeek>su</firstDayOfWeek><repeat><monthlyByDay tu='TRUE' weekdayOfMonth='second' monthFrequency='1' /></repeat><windowEnd>2016-04-26T20:00:00Z</windowEnd></rule></recurrence>");
