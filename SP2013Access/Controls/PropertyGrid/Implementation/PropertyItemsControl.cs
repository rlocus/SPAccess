...
namespace SP2013Access.Controls.PropertyGrid
{
    ...
    public class PropertyItemsControl : ItemsControl
    {
		...
		{
            //FrameworkElement.DefaultStyleKeyProperty.OverrideMetadata(typeof(PropertyItemsControl), new FrameworkPropertyMetadata(typeof(PropertyItemsControl)));
		}
        ...
        {
            bool result = item is PropertyItemBase;
            return result;
        }
