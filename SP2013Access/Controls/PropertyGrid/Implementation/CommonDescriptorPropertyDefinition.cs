...
//            {
//                return null; //new PropertiesSourceContainerHelper(parent, null);
//            }
//            return new PropertiesSourceContainerHelper(parent, this.MultipleValues);
//        }
...
//                tooltips[i] = tooltips;
//            }
//            string result = "Advanced Properties";
//            object obj2 = null;
...
//            {
//                object obj = null;
//                PropertyGridUtilities.IsSameForAllObject(this.PropertyDescriptors, (object o) => Type.GetType(GetAttribute<EditorAttribute>((PropertyDescriptor)o).EditorTypeName), out obj);
...
//            {
//                object obj3 = null;
//                PropertyGridUtilities.IsSameForAllObject(this.PropertyDescriptors, (object o) => GetAttribute<ItemsSourceAttribute>((PropertyDescriptor)o), out obj3);
...
//        private static T GetAttribute<T>(PropertyDescriptor pd) where T : Attribute
//        {
...
//        {
//            object obj = null;
//            PropertyGridUtilities.IsSameForAllObject(this.PropertyDescriptors, (object o) => GetAttribute<T>((PropertyDescriptor)o) != null, out obj);
//            return obj != null && (bool)obj;
//        }
//    }
//}