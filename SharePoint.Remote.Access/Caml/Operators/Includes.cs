...
namespace SharePoint.Remote.Access.Caml.Operators
{
    public sealed class Includes : Includes<object>
    {
        ...
        public Includes(CamlFieldRef fieldRef, object value, FieldType type) : base(fieldRef, value, type)
        {
        }

        public Includes(Guid fieldId, object value, FieldType type) : base(fieldId, value, type)
        {
        }

        public Includes(string fieldName, object value, FieldType type) : base(fieldName, value, type)
        {
        }
