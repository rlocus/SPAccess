...
namespace SP2013Access.Controls.Utilities
{
    internal static class ReflectionHelper
    {
        ...
        internal static void ValidatePublicPropertyName(object sourceObject, string propertyName)
        {
            ...
            Debug.Assert(sourceObject.GetType().GetProperty(propertyName, BindingFlags.Instance | BindingFlags.FlattenHierarchy | BindingFlags.Public) != null,
        ...
        internal static void ValidatePropertyName(object sourceObject, string propertyName)
        {
            ...
            Debug.Assert(sourceObject.GetType().GetProperty(propertyName, BindingFlags.Instance | BindingFlags.FlattenHierarchy | BindingFlags.Public | BindingFlags.NonPublic) != null,
              string.Format("Public property {0} not found on object of type {1}.", propertyName, sourceObject.GetType().FullName));
        }
